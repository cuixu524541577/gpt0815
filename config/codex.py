...
CODEX_OAUTH_DRIVER: str = "protocol"
...
# 国家优先级（逗号分隔）：取号时按此顺序尝试，无号/受限自动换下一个。
# 例："187,46,57" = 美国 → 英国 → 哥伦比亚；留空只用 SMS_COUNTRY。
# 各平台国家编号不同，请以「接码配置 → 价格查询」页显示的国家编号为准。
SMS_COUNTRY_PRIORITY: str = ""
